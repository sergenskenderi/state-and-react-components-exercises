...
/* STEP 0  
  append useState form react library
  Sergi - 17 May 2021
*/
...
export default function Moods() {
  /* STEP 1 
  created state hook and initialize it with initialMood variable 
  Sergi - 17 May 2021
  */
  ...
  return (
    <div className='widget-moods container'>
      <h2>Moods</h2>
      <div id='mood' style={style}>{mood}</div> {/* STEP 3  set the div text as mood variable*/}
      <div>
